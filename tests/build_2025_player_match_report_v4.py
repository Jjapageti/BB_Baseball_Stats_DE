...
def main(argv: list[str] | None = None) -> int:
    ...
    json_path = output_dir / "player_match_report_v4.json"
    text_path = output_dir / "player_match_report_v4.txt"
    unresolved_json_path = output_dir / "player_match_unresolved_v4.json"
    unresolved_text_path = output_dir / "player_match_unresolved_v4.txt"
