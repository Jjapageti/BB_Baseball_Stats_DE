...
def build_match_report(
    *,
    ...
    cumulative_resolved = resolve_ambiguous_by_cumulative_totals(report, index)
...
def main(argv: list[str] | None = None) -> int:
    ...
    json_path = output_dir / "player_match_report_v3.json"
    text_path = output_dir / "player_match_report_v3.txt"
    unresolved_json_path = output_dir / "player_match_unresolved_v3.json"
    unresolved_text_path = output_dir / "player_match_unresolved_v3.txt"
