...
def enrich_dataset(
    ...
    summary["unresolved_event_entries"] = len(unresolved_v3)
...
def render_report(report: dict[str, Any]) -> str:
    s = report["summary"]
    lines = [
        "===== BSM Game Log Event Enrichment v3 =====",
        "",
...
def main() -> int:
    ...
    report_json = report_dir / "event_enrichment_report_v3.json"
    report_txt = report_dir / "event_enrichment_report_v3.txt"
    unresolved_json = report_dir / "event_enrichment_unresolved_v3.json"
    resolved_v2_json = report_dir / "event_enrichment_resolved_v2.json"
    resolved_v3_json = report_dir / "event_enrichment_resolved_v3.json"
    ...
    print(f"Resolved v3 JSON: {resolved_v3_json}")
